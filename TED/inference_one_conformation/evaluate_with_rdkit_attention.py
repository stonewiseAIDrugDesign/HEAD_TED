...
def main(predict_name: str, base_local_path: str):
    model_file = f'{base_local_path}/augmentation_xtb_dft_fine_tune_model.h5'
...
if __name__ == '__main__':
    main('stonewise_dft_001')
    main('csd_test')
    main('torsionnet500_smi')
    main('turing_test_one')
